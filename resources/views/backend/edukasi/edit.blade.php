                        ...
                        <div class="card-block">
                            <form action="{{ route('backend.edukasi.update', $edukasi->id) }}" method="POST"
                                            ...
                                            <select name="kategori_id"
                                                ...
                                                @foreach ($kategori as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ old('kategori_id', $edukasi->kategori_id) == $item->id ? 'selected' : '' }}>
                                                        {{ $item->nama_kategori }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-default">
                                            <label class="float-label">Ganti Foto (Kosongkan jika tidak diubah)</label>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                @if ($edukasi->foto)
                                                    <img id="img-preview" src="{{ asset('storage/' . $edukasi->foto) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-default">
                                            ...
                                            <select name="status" class="form-control">
                                                <option value="draft" {{ $edukasi->status == 'draft' ? 'selected' : '' }}>
                                                    Draft (Hanya Admin)</option>
                                                <option value="publish"
                                                    {{ $edukasi->status == 'publish' ? 'selected' : '' }}>Publish (Tampil
                                                    di Frontend)</option>
                                            </select>
                                        </div>
                                    </div>
